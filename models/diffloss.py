...
class DiffLoss(nn.Module):
    ...
    def forward(self, target, z, index=None, mask=None, loss_weight=False):
    ...
    def sample(self, z, temperature=1.0, cfg=1.0, index=None):
...
class SimpleMLPAdaLN(nn.Module):
    ...
    def __init__(
        ...
        self.index_cond_embed = nn.Linear(1, model_channels)
    ...
    def forward(self, x, t, c, index=None):
        """
    ...
    def forward_with_cfg(self, x, t, c, cfg_scale, index):
        half = x[: len(x) // 2]
